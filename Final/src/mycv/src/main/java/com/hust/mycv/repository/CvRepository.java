...
public interface CvRepository extends JpaRepository<Cv, Integer> {
	...
	@Query(value = "select DISTINCT u from Cv u LEFT JOIN FETCH u.skills s where u.id = :id")
	Cv fetchSkillsById(Integer id);

	@Query(value = "select DISTINCT u from Cv u LEFT JOIN FETCH u.scholarships s where u.id = :id")
	Cv fetchScholarshipsById(Integer id);

	@Query(value = "select DISTINCT u from Cv u LEFT JOIN FETCH u.awards s where u.id = :id")
	Cv fetchAwardsById(Integer id);

	@Query(value = "select DISTINCT u from Cv u LEFT JOIN FETCH u.certificates s where u.id = :id")
	Cv fetchCertificatesById(Integer id);

	@Query(value = "select DISTINCT u from Cv u LEFT JOIN FETCH u.memberships s where u.id = :id")
	Cv fetchMembershipsById(Integer id);

	@Query(value = "select DISTINCT u from Cv u LEFT JOIN FETCH u.theses s where u.id = :id")
	Cv fetchThesesById(Integer id);

	@Query(value = "select DISTINCT u from Cv u LEFT JOIN FETCH u.educations s where u.id = :id")
	Cv fetchEducationsById(Integer id);

	@Query(value = "select DISTINCT u from Cv u LEFT JOIN FETCH u.works s where u.id = :id")
	Cv fetchWorksById(Integer id);

	@Query(value = "select DISTINCT u from Cv u LEFT JOIN FETCH u.projects s where u.id = :id")
	Cv fetchProjectsById(Integer id);
}
